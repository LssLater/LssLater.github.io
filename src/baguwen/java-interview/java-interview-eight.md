...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220405204034.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220405204142.png)

#### Redis 数据类型有哪些底层数据结构？

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220406190632.png)
...
![image-20220406190814021](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/image-20220406190814021.png)

客户端可以平滑扩展，提高处理能力

![image-20220406190845471](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/image-20220406190845471.png)
...
![image-20220406190953305](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/image-20220406190953305.png)

著个方法既能享受到 RDB 文件快速恢复的好处，又能享受到 AOF 只记录操作命令的简单优势, 实际环境中用的很多。
...
<img src="https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/image-20220406191045583.png" alt="image-20220406191045583" style="zoom: 80%;" />
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220406191144.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220406191225.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220406191247.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124312.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124408.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124448.png)

在主进程有数据写入时，而这个数据刚好在页c中，操作系统会创建这个页面的副本（页c的副本），即拷贝当前页的物理数据，将其映射到主进程中，而子进程还是使用原来的的页c。

#### [¶](#在重写日志整个过程时主线程有哪些地方会被阻塞) 在重写日志整个过程时，主线程有哪些地方会被阻塞？
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124552.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124651.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124739.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124804.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124832.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124912.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728124950.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728125019.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728125044.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220728125134.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153656.png)

####  新的主库选择出来后，如何进行故障的转移？

假设根据我们一开始的图：（我们假设：判断主库客观下线了，同时选出`sentinel 3`是哨兵leader）

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153724.png)

**故障转移流程如下**：

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153745.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153805.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153853.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730153955.png)

如下图所示，文件事件处理器有四个组成部分，它们分别是套接字、I/O多路复用程序、文件事件分派器以及事件处理器

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154031.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154052.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154124.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154146.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154211.png)

- **基于模式(pattern)的发布/订阅**

下图展示了一个带有频道和模式的例子， 其中 tweet.shop.* 模式匹配了 tweet.shop.kindle 频道和 tweet.shop.ipad 频道， 并且有不同的客户端分别订阅它们三个：

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154243.png)

当有信息发送到 tweet.shop.kindle 频道时， 信息除了发送给 clientX 和 clientY 之外， 还会发送给订阅 tweet.shop.* 模式的 client123 和 client256 ：

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154404.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220730154532.png)

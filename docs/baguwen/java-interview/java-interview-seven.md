...
### [¶](#81-原理和sql) 8.1 原理和SQL

#### [¶](#什么是事务事务基本特性acid) 什么是事务？事务基本特性ACID？

事务指的是满足 ACID 特性的一组操作，可以通过 Commit 提交一个事务，也可以使用 Rollback 进行回滚。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232141.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232206.png)

- **读脏数据**

T1 修改一个数据，T2 随后读取这个数据。如果 T1 撤销了这次修改，那么 T2 读取的数据是脏数据。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232225.png)

- **不可重复读**

T2 读取一个数据，T1 对该数据做了修改。如果 T2 再次读取这个数据，此时读取的结果和第一次读取的结果不同。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232242.png)

- **幻影读**

T1 读取某个范围的数据，T2 在这个范围内插入新的数据，T1 再次读取这个范围的数据，此时读取的结果和和第一次读取的结果不同。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232257.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232532.png)
...
#### [¶](#什么是b树为什么b树成为主要的sql数据库的索引实现) 什么是B+树？为什么B+树成为主要的SQL数据库的索引实现？
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232602.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232621.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232741.png)

如上图，DB_ROW_ID是数据库默认为该行记录生成的唯一隐式主键；DB_TRX_ID是当前操作该记录的事务ID； 而DB_ROLL_PTR是一个回滚指针，用于配合undo日志，指向上一个旧版本；delete flag没有展示出来。

1. **undo log**

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232815.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232832.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232910.png)

这时候版本链就是

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232925.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404232959.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404233028.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404233101.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404234926.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221407.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221432.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221510.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221644.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221716.png)
...
果计算100+98的值，那么操作数栈的变化如下图

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221755.png)
...
1.8开始方法区（HotSpot的永久代）被彻底删除了，取而代之的是元空间，元空间直接使用的是本机内存。参数设置：
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221829.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221853.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404221919.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222016.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222122.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222153.png)

让所有存活的对象都向一端移动，然后直接清理掉端边界以外的内存。

- **复制**

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222211.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222253.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222417.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222447.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222507.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222601.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222645.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222714.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222736.png)

G1 把堆划分成多个大小相等的独立区域(Region)，新生代和老年代不再物理隔离。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222750.png)

**通过引入 Region 的概念，从而将原来的一整块内存空间划分成多个的小空间，使得每个小空间可以单独进行垃圾回收**。这种划分方法带来了很大的灵活性，使得可预测的停顿时间模型成为可能。通过记录每个 Region 垃圾回收时间以及回收所获得的空间(这两个值是通过过去回收的经验获得)，并维护一个优先列表，每次根据允许的收集时间，优先回收价值最大的 Region。

每个 Region 都有一个 Remembered Set，用来记录该 Region 对象的引用对象所在的 Region。通过使用 Remembered Set，在做可达性分析的时候就可以避免全堆扫描。

![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404222817.png)
...
![](https://exchange-imgs2021.oss-cn-beijing.aliyuncs.com/img/20220404223108.png)
